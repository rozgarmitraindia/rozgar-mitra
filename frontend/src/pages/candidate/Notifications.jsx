        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground">Application, interview, room and account updates appear here.</p>
            </div>
        ...
        <div className="grid gap-3">
          ...
          {!loading && !items.length ? (
            <div className="rounded-2xl border border-dashed border-border bg-card p-12 text-center shadow-float">
              ...
              <p className="mt-2 text-sm text-muted-foreground">New application and interview updates will appear here automatically.</p>
            </div>
          ) : null}
        </div>
      </div>
